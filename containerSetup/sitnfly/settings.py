...
TEMPLATES = [
    {
        ...
        'DIRS': [
            BASE_DIR/'sitnfly'/'frontend'/'templates'
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'sitnfly', 'frontend', 'static')]
...
SECURE_SSL_REDIRECT = False # Can't turn on due to Cloudflare already doing this, will result in infinite redirects.
